...
# visualize models within a 'parameter space'
# each model thought of as ordered pair
...
# instead of using random models generated by runif
# we can use a 'grid search' approach
...
# for linear models, R has some functions to handle this
# the neat thing about above is it works for any parametric model
